...
:edition: 1
:ref-docnumber: ISO 37100:2018(E)
:copyright-year: 2019
:language: en
:title-intro-en: Computer applications in terminology
:title-main-en: Naming
:title-part-en: Structure of personal names
:title-intro-fr: Applications informatiques en terminologie
:title-main-fr: Nommage
:title-part-fr: Structure des noms de personnes
