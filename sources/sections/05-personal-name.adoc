...
A personal name is composed of multiple components.
Personal names are modelled with the cultural origin and information provided within a personal name in mind.
...
Names are modelled in constituent components
or as a complete name string.
...
A representation of an intentionally anonymous personal name.


=== Unknown

A representation of an unknown personal name.


=== Varii

Descriptors of individuals, such as "Various Authors", should be given as completeName
elements.

As with pseudonyms, the real name of the creator if known can be
