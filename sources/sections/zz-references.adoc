...
* [[[ISO639-3,ISO 639-3]]], _Codes for the representation of names of languages -- Part 3: Alpha-3 code for comprehensive coverage of languages_
...
* [[[rfc2046,IETF RFC 2046]]], Freed, N., Borenstein, N.
